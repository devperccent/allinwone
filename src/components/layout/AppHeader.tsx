...
export const AppHeader = memo(function AppHeader({ searchOpen, onSearchOpenChange, onOpenShortcuts }: AppHeaderProps) {
  ...
  return (
    <header className="app-titlebar flex items-center justify-between h-12 px-3 md:px-5 border-b border-border bg-card gap-2" role="banner" aria-label="Application header">
